            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="#" @submit.prevent="addArticle">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="custom-control custom-switch switch-lg custom-switch-success mr-2 mb-1">
                                                ...
                                                <toggle-button @change="setBelongsTo()" :width="70" :labels="{checked: 'Seller', unchecked: 'Buyer'}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div v-for="(category, key) in categories" :key="key" class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" :value="category.id" v-model="article.categories" @change="setCategories($event)" name="category" :id="'category' + category.id" >
    ...
    export default {
        ...
        methods: {
            addArticle(){
                ...
                axios.post('support/article/store', this.article).then( response => {
                    this.spinner = false;
