...
Route::get('/dashboard', 'DashboardController@dashboardAnalytics')->middleware('user.auth');


Route::get('/support-category', 'Support\CategoryController@index')->middleware('user.auth');
Route::get('/support-article', 'Support\ArticleController@index')->middleware('user.auth');
Route::middleware('user.auth')->prefix('/support')->group(function() {
    Route::prefix('/category')->group(function() {
        Route::get('/index', 'Support\CategoryController@index');
        Route::post('/store', 'Support\CategoryController@store');
        Route::get('/{id}/get', 'Support\CategoryController@getCategory');
        Route::post('/{id}/update', 'Support\CategoryController@update');
        Route::get('/{id}/delete', 'Support\CategoryController@destroy');
        Route::get('/all/{for?}', 'Support\CategoryController@getCategories');
        Route::get('/children', 'Support\CategoryController@getCategoriesWithChildren');
    });

    Route::prefix('/article')->group(function() {
        Route::get('/create', 'Support\ArticleController@create');
        Route::post('/store', 'Support\ArticleController@store');
        Route::get('/{id}/edit', 'Support\ArticleController@edit');
        Route::post('/{id}/update', 'Support\ArticleController@update');
        Route::get('/{id}/get', 'Support\ArticleController@getArticle');
        Route::get('/{id}/delete', 'Support\ArticleController@destroy');
        Route::get('/all', 'Support\ArticleController@getArticles');
    });
});
